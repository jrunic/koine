...
def test_antigravity_render_titulo_e_refs():
    out = antigravity.renderizar(_cm()).arquivos_working_dir["GEMINI.md"]
    ...
    refs_cla = [l for l in claude.renderizar(_cm()).arquivos_working_dir["CLAUDE.md"]
...
def test_antigravity_bootstrap_titulo():
    ...
    out = antigravity.renderizar(cm).arquivos_working_dir["GEMINI.md"]
