...
def instalar_shim(bindir: str, nome: str, captura: str, captura_env: str = "") -> str:
    """Cria um shim executável <bindir>/<nome> que grava cwd + args em <captura>
    (uma linha: cwd\\n, depois os args) e sai 0. Simula o cliente IA lançado.
    Se captura_env for dado, também despeja o env do processo nesse arquivo."""
